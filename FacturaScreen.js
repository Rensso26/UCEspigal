...
const FacturaScreen = () => {
  ...
  const { cart, clientData } = useContext(CartContext); 
  const { customerData } = useContext(CustomerContext);// Obtener datos del carrito y cliente del contexto
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.detailSection}>
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>{customerData.idCard || 'N/A'}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Nombre y Apellido: </Text>
            <Text style={styles.detailValue}>{customerData.name || 'N/A'} </Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Correo: </Text>
            <Text style={styles.detailValue}>{customerData.email || 'N/A'}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Domicilio: </Text>
            <Text style={styles.detailValue}>{customerData.address || 'N/A'}</Text>
          </View>
          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Número de Teléfono: </Text>
            <Text style={styles.detailValue}>{customerData.phone || 'N/A'}</Text>
          </View>
        </View>
